...
//  CrocoMini
//
//  Created by Tatiana Mudryak on 27/11/2017.
...
//#import "CrocoMini-Swift.h"

NSString *const SearchViewControllerTabBatTitle = @"Поиск";
NSString *const PurchasesViewControllerTabBatTitle = @"";
...
//	PurchasesListViewController *purchasesViewController = [PurchasesListViewController new];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"CrocoMini"];
